...
--> statement-breakpoint
CREATE TABLE `SubscriblePlanUsers` (
	`id` varchar(36) NOT NULL,
...
ALTER TABLE `SubscriblePlanUsers` ADD CONSTRAINT `SubscriblePlanUsers_planId_Plans_id_fk` FOREIGN KEY (`planId`) REFERENCES `Plans`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `SubscriblePlanUsers` ADD CONSTRAINT `SubscriblePlanUsers_userId_User_id_fk` FOREIGN KEY (`userId`) REFERENCES `User`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `UserLimit` ADD CONSTRAINT `UserLimit_userId_User_id_fk` FOREIGN KEY (`userId`) REFERENCES `User`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
